...
namespace I18N {
    ...
    static std::unordered_map<std::string, std::unordered_map<Language, std::string>> translations = {
        ...
        {"esp_model_highlight", {{Language::English, "Model Highlight"} ZH("模型高亮")}},
        {"esp_occluded_only", {{Language::English, "Occluded Parts Only"} ZH("仅显示遮挡部分")}},
        {"esp_model_highlight_hint", {{Language::English, "Uses Unity's camera command buffer and built-in shader. Disable skeleton and boxes for a cleaner ESP."} ZH("使用 Unity 相机命令缓冲和内置着色器。关闭骨骼与方框可获得更简洁的效果。")}},
